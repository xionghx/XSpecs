...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/xionghx/XFoundation"
...
#  spec.license      = "MIT (example)"
  ...
  spec.author             = { "xionghx" => "xionghuanxin@hotmail.com" }
  # Or just: spec.author    = "xionghx"
  # spec.authors            = { "xionghx" => "xionghuanxin@hotmail.com" }
  # spec.social_media_url   = "https://twitter.com/xionghx"
...
#   spec.platform     = :ios, "9.0"
  ...
  spec.source       = { :git => "https://github.com/xionghx/XFoundation.git", :tag => "#{spec.version}" }
